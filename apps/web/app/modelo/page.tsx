        ...
        <div className="min-w-0 space-y-12">
          ...
          <Section id="reglas" titulo="Reglas de negocio adicionales">
            ...
            <ul className="max-w-3xl space-y-2 text-[14px] text-ink-700">
              ...
              <Bullet><strong>InStock (repuestos de pauta):</strong> los repuestos de las pautas de mantención de <strong>Ford Transit, Ranger y F-150 (años modelo 2023 y 2024)</strong> y de <strong>Hyundai Accent, Grand i10 e i20 (todas sus generaciones)</strong> no pueden faltar en las sucursales con taller (Linderos, Rancagua, Curicó y Chillán): si entre stock, tránsito y sugerido no llegan a 2 unidades, el sugerido se completa hasta esa cifra aunque el modelo no pida nada, y la fila aparece igual con “solo pedir” activado. La columna <strong>InStock</strong> marca esos repuestos en toda la grilla; el mínimo solo obliga en las cuatro sucursales con taller. No entran lubricantes ni consumibles (aceite, fluido de frenos, refrigerante): se venden por litro y un mínimo de “2 unidades” no significa nada sobre ellos.</Bullet>
