...
import { COLUMNAS_CAT, KEYS_CAT_DEFAULT } from "@/lib/columnas-catalogo";
...
export function ConfigurarColumnasCatalogo({ open, onClose, visibles, onChange }: Props) {
  ...
  return (
    <Dialog
      ...
      description="Elige qué columnas mostrar en el catálogo. Se guardan en este navegador."
    >
      ...
      <div className="mt-4 flex justify-between border-t border-slate-100 pt-3">
        <Button variant="ghost" size="sm" onClick={() => onChange(KEYS_CAT_DEFAULT)}>
